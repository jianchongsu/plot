...
<img src="http://i.imgur.com/Kpm16.png"   style="display:block; margin: auto" alt="plot of chunk data_plot" title="plot of chunk data_plot" /> 
...
<img src="http://i.imgur.com/YClBr.png"   style="display:block; margin: auto" alt="plot of chunk barplot and waterfallplot" title="plot of chunk barplot and waterfallplot" /> 
...
plot(sun.m.1997, xlab = "1997年", ylab = "太阳黑子数", type = "n", xlim = c(0.5, 
    12.5), ylim = c(0, max(sun.m.1997)), xaxt = "n", panel.first = grid(), main = "1997年太阳黑子数攼<U+3E37><U+383C><U+3E30>eth
...
<img src="http://i.imgur.com/xvlqB.png"   style="display:block; margin: auto" alt="plot of chunk waterfall" title="plot of chunk waterfall" /> 
...
plot(sun.m.1996, xlab = "1995年", ylab = "太阳黑子数", type = "n", xlim = c(0.5, 
    12.5), ylim = c(0, max(sun.m.1995)), xaxt = "n", panel.first = grid(), main = "1995年太阳黑子数攼<U+3E37><U+383C><U+3E30>axis(1, 1:12, sprintf(c("一%s", "二%s", "三%s", "四%s", "五%s", "六%s", "七%s", 
    "八%s", "九%s", "十%s", "十一%s", "十二%s"),
rect(1:12 - 0.3, c(0, sun.m.1995[1:11]), 1:12 + 0.3, sun.m.1995, col = c("cyan", 
    ifelse(diff(sun.m.1997) < 0, "red", "blue")))
{% endhighlight %}

<img src="http://i.imgur.com/Trihv.png"   style="display:block; margin: auto" alt="plot of chunk waterfall 96vs97" title="plot of chunk waterfall 96vs97" /> 
...
<img src="http://i.imgur.com/ghghB.png"   style="display:block; margin: auto" alt="plot of chunk action" title="plot of chunk action" /> 
...
<img src="http://i.imgur.com/vV8ly.png"   style="display:block; margin: auto" alt="plot of chunk actuon2" title="plot of chunk actuon2" /> 
